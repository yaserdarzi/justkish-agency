...
class CreateTicket extends Component {
    ...
    _selectCategorie = async (item) => {
        ...
        this.selectHoby.current.style.display = 'none';
            

    }


    // enter and leave select menu
    enterSelectHoby = () =>{
        this.selectHoby.current.style.display = 'block'
    }
                ...
                <div className="create-ticket-box container" >
                    ...
                    <div className="part2" >
                        ...
                        <div className="create-ticket-filter " >
                            ...
                            <div className="create-ticket-search">
                                <div className="create-ticket-features" onMouseEnter={this.enterSelectHoby} onMouseLeave={this.leaveSelectHoby}>
                                    <span className="create-ticket-features-right" >
                                        <span>{this.state.categorie || 'همه'} </span>
                                    </span>
                                    <img src={arrowdown2} alt="فلش" />
                                    <ul className="create-ticket-features-lists" ref={this.selectHoby} >
                                        <li className="create-ticket-features-list" >
                                            <ul className="create-ticket-features-col" >
                                                {renderCategory}
                                            </ul>
